...
ax[:plot](db,abs.(pi*r^2 .- sn),label=L"$r=0.1$, This work",".")
...
ax[:plot](db,abs.(sn-convert(Array{Float64,1},sn_big)),label=L"$r=0.1$, This work",".")
...
ax[:plot](db,sn,label=L"$r=0.1$, This work",".")
