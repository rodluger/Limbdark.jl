...
ax[:plot](log10.(db),log10.(abs.(pi*r^2-sn)),label="r=0.1, AL(2018)",".")
...
ax[:plot](log10.(db),log10.(abs.(sn-convert(Array{Float64,1},sn_big))),label="r=0.1, AL(2018)",".")
ax[:set_xlabel](L"$\log_{10}(b-(1-r))$")
...
ax[:plot](log10.(db),log10.(sn),label="r=0.1, AL(2018)",".")
