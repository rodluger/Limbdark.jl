...
ax[:plot](b,flux,label="LA 2018",linestyle="-.",lw=3,color="r")
ax[:set_xlabel]("b")
ax[:set_ylabel]("Flux")
...
ax[:plot](b,flux_grad[:,1],label="df/dr LA 2018",linestyle="-.",lw=3)
ax[:plot](b,flux_grad[:,2],label="df/db LA 2018",linestyle="-.",lw=3)
ax[:plot](b,50.*flux_grad[:,3],label="50x df/du1 LA 2018",linestyle="-.",lw=3)
ax[:plot](b,50.*flux_grad[:,4],label="50x df/du2 LA 2018",linestyle="-.",lw=3)
...
ax = axes[3]
ax[:semilogy](b,abs.(1.-data_pal[:,1]-flux_big),label="diff flux Pal-LA 2018 BigFloat")
ax[:plot](b,abs.(-data_pal[:,2]-flux_grad_big[:,1]),label="diff df/dr Pal-LA 2018 BigFloat")
ax[:plot](b,abs.(-data_pal[:,3]-flux_grad_big[:,2]),label="diff df/db Pal-LA 2018 BigFloat")
ax[:plot](b,abs.(-data_pal[:,4]-flux_grad_big[:,3]),label="diff df/du1 Pal-LA 2018 BigFloat")
ax[:plot](b,abs.(-data_pal[:,5]-flux_grad_big[:,4]),label="diff df/du2 Pal-LA 2018 BigFloat")
ax[:set_xlabel]("b")
ax[:set_ylabel]("Differences of flux, derivatives")
ax[:legend](loc="lower left",fontsize=6)

savefig("compare_pal_r0.1.pdf", bbox_inches="tight")
