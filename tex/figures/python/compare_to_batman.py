...
for i, N in enumerate(Narr):
    ...
    starry_time[i] = float(foo.decode('utf-8'))
    starry_flux = np.loadtxt("flux.txt")
...
ax.plot(Narr, starry_time, 'o', ms=ms(err_starry), color='C0')
ax.plot(Narr, starry_time, '-', lw=0.5, color='C0', label='This work')
...
axleg1.plot([0, 1], [0, 1], color='C1', label='batman')
axleg1.set_xlim(2, 3)
