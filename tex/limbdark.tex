...
\begin{figure}
    ...
    without (dashed) time-integration.  The integration time, $\Delta t = 0.3$, is indicated in the
    ...
    $t_0 = 0$, $b_0=0.5$, and $u_1=u_2=0.3$. \jlcodelink{integrate_transit_gradient}
