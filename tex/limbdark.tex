...
\end{align}
%
where $I_0 \equiv I(1)$, $u_0 \equiv -1$, and $\upmu = \cos\theta$, where
$\theta$ is the angle between the line of sight and the vector normal to 
...
\begin{align}
    ...
    \mathcal{F} &= I_0 \oiint \gbasis^\mathsf{T} (z) \, \dd S \, \bvec{A} \bvec{u} \nonumber \\
