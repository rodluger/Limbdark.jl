...
\todo{Eric: Should we define the $\eta$ function here so the reader doesn't have
to refer to Mandel \& Agol?}
\begin{proof}{Eta}
    \label{eq:eta}
    \eta(r,b) &=
    \begin{dcases}
...
\eric{There was a sign missing in front of the second line of the equation.}
