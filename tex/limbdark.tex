...
The code presented in this paper is open source and is implemented in \textbf{three} 
...
\textbf{another of which is implemented as the default transit model in the 
...
the {\bf quadratic limb-darkened} flux model in \texttt{IDL}, without derivatives; 
