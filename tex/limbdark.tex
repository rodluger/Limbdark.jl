...
\cos{\kappa_1} &=& \left(\frac{b^2+(1-r)(1+r)}{2b}\right),
\end{eqnarray}
...
\footnote{Note that since $\upmu = \sqrt{1-r^2}$, this problem is equivalent to 
...
Note that the total flux of this basis set integrates to zero.
...
\item Compare derivatives with Pal for speed and accuracy.
\end{itemize}
