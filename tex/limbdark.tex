...
$(x,y,z)$ are the coordinates of the unit sphere, then we only require
Green's functions which have a dependence on $z$.  We choose a Green's function
of the form
...
\end{eqnarray}
This yields particularly simple form for the primitive integrals
\begin{align}
    \label{eq:primitiveP}
    \mathcal{P}(\bvec{G}_n) &=
...
\end{equation}
for odd values of $n \ge 3$.

Each of the terms $(k^2-\sin^2\xi)^c$ can be exanded with the binomial theorem,
and then expressed in terms of the integrals $I_v$ and $J_v$ as
\begin{eqnarray}
