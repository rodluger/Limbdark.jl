...
The code presented in this paper is open source and has \textbf{three} versions: one of which is a part
of the \starry package, \texttt{http://github.com/rodluger/starry/}, written
in a combination of \texttt{C++} and \Python, 
\textbf{another of which is implemented as the default transit model in the \exoplanet package
