...
the Julia implementation of these routines takes about 60\% of the CPU
time as the IDL EXOFAST implementation without derivatives, and about 75\%
of the computation time when including the derivatives.  Consequently, we
conclude that our new implementation is both faster (by 25-40\%) and more 
...
(depending on the order of the limb-darkening), and 25-40\% faster than EXOFAST.
