...
\todo{Before we begin defining the $S_0$, $S_1$, ... functions, we need to
...
curve is that our computations make use of the visible area of the disk, $S_0$, defined as
...
the first basis function in the \starry implementation from \citet{starry}.
...
\frac{\partial S_0(r,b)}{\partial b} &= \frac{2A_{kite}}{b},
\end{proof}
...
The $S_1(r,b)$ function is plotted in Figure \ref{transit_linear}.  The
...
\begin{figure}[p!]
    ...
    \caption{The numerical error in computing the flux of an eclipsed, linearly
    limb-darkened star ($u_1=1$) using the $S_1(r,b)$ formalism introduced in this
...
\todo{We need an equation here explicitly stating the derivatives of the $S_2$ term.}
