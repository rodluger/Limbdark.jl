...
\begin{abstract}
 ...
 arbitrary integer order.  We provide updated analytic expressions for the
...
\begin{figure}
    ...
    \caption{Comparison of Mandel \& Agol (2002) with Luger \& Agol (2018).}
    \label{fig:compareMA}
    \end{centering} 
\end{figure}
...
{\color{red} Compare the speed of evaluation as well. Right now,
the Pal computation takes 0.96 seconds to compute $10^6$ models
while the transit\_poly.jl takes 3.5 seconds.  There is probably
some room for further optimization of the code.}

\begin{figure}
    \begin{centering}
    \includegraphics[width=\linewidth]{figures/julia/compare_pal_r0pt1.pdf}
    \caption{Comparison of \citet{Pal2008} with Luger \& Agol (2018).}
...
\begin{itemize}
\item Compare with Gimenez for speed and accuracy
for higher order limb-darkening.
