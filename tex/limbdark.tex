...
For uniform, linear or quadratic limb darkening, the IDL package EXOFAST 
...
\citep{Eastman2013}.  EXOFAST also uses a series
...
We have carried out a numerical comparison of the EXOFAST implementation
...
We note that EXOFAST v2.0 has now been updated to utilize the numerically-stable 
