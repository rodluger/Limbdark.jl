...
this parameter is given by $\upmu = \cos{\theta} =\sqrt{1-r^2}$, where $0\le r \le 1$.
...
expression for the linear limb-darkening flux, $s_2(r,b)= S_1(r,b)$,
\begin{align}
...
as
\begin{eqnarray}
\frac{F(u_1,r,b)}{F_0} &=& \frac{u_1 s_2(r,b) + \pi(1-u_1)(1-\Lambda^e)}{\frac{2\pi}{3}u_1 + \pi(1-u_1)},\\
...
with the computed $a_n$ values, we can find $d_n$ from downward recursion
using the relation
\begin{equation}
...
$F_0$ is the unobscured flux, and $S_1=s_2$ is given by the linear limb-darkened solution 
