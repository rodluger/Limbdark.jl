...
\begin{figure}
    ...
    limiting precision for representing $\pi r^2$. \jlcodelink{area_of_overlap_r01}}\label{fig:overlap_precision}
    \end{centering}
\end{figure}
...
\begin{figure}\label{s2_plot}
    ...
    limb-darkened star ($u_1=1$), $S_1(r,b)$. \jlcodelink{s2_residuals}}
    \end{centering}
\end{figure}

\begin{figure}\label{s2_plot_MA2002}
    \begin{centering}
    \includegraphics[width=0.85\linewidth]{figures/julia/s2_residuals_MA2002.pdf}
    \caption{The numerical error in computing the flux of an eclipsed, linearly
             limb-darkened star using the code from \citet{MandelAgol2002}.
             \jlcodelink{s2_residuals_MA2002}}
    \end{centering}
\end{figure}
...
\begin{figure}\label{s2_machine}
    ...
    computation with \texttt{BigFloat} precision (256-bit). \jlcodelink{s2_machine}}
    \end{centering}
\end{figure}
...
$\frac{\partial a_n}{\partial u_i}$, and differentiating each term in equation
\ref{eq:dn_of_an} to obtain $\frac{\partial d_j}{\partial a_n}$, and propagating 
...
\begin{figure}
    ...
    beyond a sextic fit. \jlcodelink{occult_nonlinear}}
    \label{fig:nonlinear}
    \end{centering}
\end{figure}
