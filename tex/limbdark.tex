...
accurate than the \cite{MandelAgol2002} IDL implementation.  
...
in a combination of C++ and Python, and a new code written in \texttt{Julia},
\texttt{http://github.com/rodluger/limbdark/}, as
part of the development of the equations in this paper.  We have also implemented
the flux model in IDL, without derivatives; this is also available within
