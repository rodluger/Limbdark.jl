...
function integrate_timestep_track(param::Array{T,1},trans::Transit_Struct{T},t1::T,t2::T,tol::T,maxdepth::Int64) where {T <: Real}
...
function integrate_timestep(param::Array{T,1},trans::Transit_Struct{T},t1::T,t2::T,tol::T,maxdepth::Int64) where {T <: Real}
...
#  println("depth: ",depth," b: ",trans.b," f1: ",f1," fmid: ",fmid," f2: ",f2)
  # Tolerance is set by the flux term only:
#  d = abs(fmid0-fapprox[1])
  d = maximum(abs,fmid-fapprox)
  if d > tol && depth < maxdepth
     # Compute: flux, df/dr, df/dt0, df/dv, df/db0, df/d d_n:
